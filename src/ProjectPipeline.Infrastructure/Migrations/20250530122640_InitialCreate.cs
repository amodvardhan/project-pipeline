        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadOfUnit = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedClosureDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    ProfilesSubmitted = table.Column<int>(type: "int", nullable: false),
                    ProfilesShortlisted = table.Column<int>(type: "int", nullable: false),
                    ProfilesSelected = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileSubmissions_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileSubmissions_ProjectId",
